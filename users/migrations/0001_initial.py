# Generated by Django 4.2 on 2024-03-13 07:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirm_code', models.CharField(blank=True, max_length=6, null=True)),
                ('last_name', models.CharField(max_length=30)),
                ('phone', models.CharField(max_length=15)),
                ('anonym', models.UUIDField(default=uuid.uuid4, editable=False)),
                ('confirm_token', models.CharField(blank=True, max_length=500, null=True)),
